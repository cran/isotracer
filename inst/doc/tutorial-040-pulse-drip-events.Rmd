...
<img src="figures/z-fig-040-unnamed-chunk-5-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-040-unnamed-chunk-14-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-040-unnamed-chunk-16-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-040-unnamed-chunk-18-1.jpeg" alt="" style="display: block; margin: auto;" />
...
```
## Error in `encode_priors()`:
## ! One or several parameters are missing a prior.
## You can list the current model priors with `priors(...)`.
## You can list the missing model priors with `missing_priors(...)`.
```

<img src="figures/z-fig-040-unnamed-chunk-29-1.jpeg" alt="" style="display: block; margin: auto;" />
...
```
## Error in `purrr::map()` at 2018-05_isotracer/R/ui_predictions.R:97:5:
## ℹ In index: 1.
## Caused by error in `project()` at 2018-05_isotracer/R/ui_projection-simulation.R:163:5:
## ! !any(is.na(params$value)) is not TRUE
```

<img src="figures/z-fig-040-unnamed-chunk-31-1.jpeg" alt="" style="display: block; margin: auto;" />
