...
<img src="figures/z-fig-010-plot-data-1.png" title="plot of chunk plot-data" alt="plot of chunk plot-data" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-010-unnamed-chunk-8-1.png" title="plot of chunk unnamed-chunk-8" alt="plot of chunk unnamed-chunk-8" style="display: block; margin: auto;" />
...
Since we are using a Bayesian approach, each parameter has a prior associated with it. We will see later how to customize the priors, but for this example we will keep the defaults. The default priors are a half-Cauchy distribution with a scale of 0.1. The current priors can be accessed with the `priors()` function:
...
<img src="figures/z-fig-010-unnamed-chunk-17-1.png" title="plot of chunk unnamed-chunk-17" alt="plot of chunk unnamed-chunk-17" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-010-unnamed-chunk-20-1.png" title="plot of chunk unnamed-chunk-20" alt="plot of chunk unnamed-chunk-20" style="display: block; margin: auto;" />
