...
<img src="figures/z-fig-030-unnamed-chunk-5-1.jpeg" alt="" style="display: block; margin: auto;" />
...
## ℹ Summaries were computed grouped by species and transect.
## ℹ Output is grouped by species.
## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
## ℹ Use `summarise(.by = c(species, transect))` for per-operation grouping (`?dplyr::dplyr_by`) instead.
```
...
```
## `summarise()` has regrouped the output.
## ℹ Summaries were computed grouped by transect and species.
## ℹ Output is grouped by transect.
## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
## ℹ Use `summarise(.by = c(transect, species))` for per-operation grouping (`?dplyr::dplyr_by`) instead.
```
...
<img src="figures/z-fig-030-unnamed-chunk-24-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-030-unnamed-chunk-26-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-030-unnamed-chunk-27-1.jpeg" alt="" style="display: block; margin: auto;" />
