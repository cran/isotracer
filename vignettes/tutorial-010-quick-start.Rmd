...
<img src="figures/z-fig-010-plot-data-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<b>Note:</b> In this example and in all later tutorials, we use the [pipe operator](https://magrittr.tidyverse.org/) `%>%` which you are probably familiar with if you have been using the [tidyverse](https://tidyverse.org/) packages. Of course, you can also use the isotracer functions without the pipe operator if you prefer!
...
<img src="figures/z-fig-010-unnamed-chunk-8-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-010-unnamed-chunk-18-1.jpeg" alt="" style="display: block; margin: auto;" />
...
<img src="figures/z-fig-010-unnamed-chunk-21-1.jpeg" alt="" style="display: block; margin: auto;" />
