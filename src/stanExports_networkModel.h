...
template <typename T0__, typename T1__, typename T2__, typename T3__,
          ...
          stan::require_all_t<stan::is_integral<T0__>,
                              ...
                              stan::is_integral<stan::value_type_t<T2__>>,
                              stan::is_integral<T3__>,
                              stan::is_std_vector<T4__>,
                              stan::is_std_vector<stan::value_type_t<T4__>>,
                              stan::is_integral<stan::value_type_t<stan::value_type_t<T4__>>>,
                              stan::is_integral<T5__>,
                              stan::is_std_vector<T6__>,
                              stan::is_std_vector<stan::value_type_t<T6__>>,
                              stan::is_integral<stan::value_type_t<stan::value_type_t<T6__>>>,
                              stan::is_std_vector<T7__>,
                              stan::math::disjunction<stan::is_autodiff_scalar<
                                                        stan::value_type_t<T7__>>,
                                stan::is_floating_point<stan::value_type_t<T7__>>>>* = nullptr>
Eigen::Matrix<stan::return_type_t<stan::base_type_t<T7__>>,-1,-1>
buildTransferMatrix(const T0__& nComps, const T1__& nSteady, const T2__&
                    steadyIndices, const T3__& nUpsilons, const T4__&
                    mappingU, const T5__& nLambdas, const T6__& mappingL,
                    const T7__& params, std::ostream* pstream__);
...
Eigen::Matrix<stan::return_type_t<stan::base_type_t<T1__>, T2__>,-1,-1>
buildTransferMatrixDecay(const T0__& nComps, const T1__& transferRef_arg__,
...
template <typename T0__, typename T1__, typename T2__, typename T3__,
          ...
          stan::require_all_t<stan::is_integral<T0__>,
                              ...
                              stan::is_integral<stan::value_type_t<stan::value_type_t<T2__>>>,
                              stan::is_integral<T3__>,
                              stan::is_std_vector<T4__>,
                              stan::is_std_vector<stan::value_type_t<T4__>>,
                              stan::is_integral<stan::value_type_t<stan::value_type_t<T4__>>>,
                              ...
                              stan::math::disjunction<stan::is_autodiff_scalar<
                                ...
                                stan::is_floating_point<stan::value_type_t<T6__>>>>* = nullptr>
Eigen::Matrix<stan::return_type_t<T5__, stan::base_type_t<T6__>>,-1,-1>
buildTransitionMatrix(const T0__& nComps, const T1__& nUpsilons, const T2__&
                      mappingU, const T3__& nLambdas, const T4__& mappingL,
                      const T5__& dt, const T6__& params, std::ostream*
                      pstream__);
template <typename T0__, typename T1__, typename T2__, typename T3__,
          stan::require_all_t<stan::is_integral<T0__>,
                              stan::is_eigen_matrix_dynamic<T1__>,
...
Eigen::Matrix<stan::return_type_t<stan::base_type_t<T1__>, T2__, T3__>,-1,-1>
buildTransitionMatrixDecay(const T0__& nComps, const T1__&
...
template <typename T0__, typename T1__, typename T2__, typename T3__,
          ...
          stan::require_all_t<stan::is_integral<T0__>,
                              ...
                              stan::is_std_vector<T4__>,
                              stan::is_col_vector<stan::value_type_t<T4__>>,
                              stan::is_vt_not_complex<stan::value_type_t<T4__>>,
                              stan::is_std_vector<T5__>,
                              stan::is_std_vector<stan::value_type_t<T5__>>,
                              stan::is_integral<stan::value_type_t<stan::value_type_t<T5__>>>,
                              stan::is_integral<T6__>,
                              stan::is_std_vector<T7__>,
                              stan::is_integral<stan::value_type_t<T7__>>,
                              ...
                              stan::math::disjunction<stan::is_autodiff_scalar<
                                ...
                                stan::is_floating_point<stan::value_type_t<
                                                          stan::value_type_t<T8__>>>>>* = nullptr>
std::vector<
  stan::return_type_t<stan::base_type_t<T3__>, stan::base_type_t<T4__>,
    stan::base_type_t<T8__>>>
buildSizePredictions(const T0__& nObs, const T1__& currentGroup, const T2__&
                     maxNobs, const T3__& unmarked, const T4__& marked,
                     const T5__& indices, const T6__& splitPresent,
                     const T7__& splitComps, const T8__& initRefr,
...
std::vector<
  stan::return_type_t<stan::base_type_t<T3__>, stan::base_type_t<T4__>,
    stan::base_type_t<T8__>>>
buildPropPredictions(const T0__& nObs, const T1__& currentGroup, const T2__&
                     maxNobs, const T3__& unmarked, const T4__& marked,
                     const T5__& indices, const T6__& splitPresent,
                     const T7__& splitComps, const T8__& initRefr,
                     std::ostream* pstream__);
/* matrix
   buildTransferMatrix(int, int, array[] int, int, array[,] int, int,
...
buildTransferMatrix(const T0__& nComps, const T1__& nSteady, const T2__&
  ...
  try {
    ...
    stan::model::assign(transfer,
      stan::math::rep_matrix(static_cast<double>(0), nComps, nComps),
    ...
    stan::model::assign(lossRates,
      stan::math::rep_vector(static_cast<double>(0), nComps),
...
// matrix buildTransferMatrixDecay(int, matrix, real)
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::is_integral<T0__>,
                              stan::is_eigen_matrix_dynamic<T1__>,
                              stan::is_vt_not_complex<T1__>,
...
buildTransferMatrixDecay(const T0__& nComps, const T1__& transferRef_arg__,
                         const T2__& lambda_decay, std::ostream* pstream__) {
  using local_scalar_t__ = stan::return_type_t<stan::base_type_t<T1__>, T2__>;
  int current_statement__ = 0;
  // suppress unused var warning
  (void) current_statement__;
...
/* matrix
   buildTransitionMatrix(int, int, array[,] int, int, array[,] int, real,
                         array[] real)
 */
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__,
          stan::require_all_t<stan::is_integral<T0__>,
                              ...
                              stan::math::disjunction<stan::is_autodiff_scalar<
                                                        stan::value_type_t<T6__>>,
                                stan::is_floating_point<stan::value_type_t<T6__>>>>*>
Eigen::Matrix<stan::return_type_t<T5__, stan::base_type_t<T6__>>,-1,-1>
buildTransitionMatrix(const T0__& nComps, const T1__& nUpsilons, const T2__&
                      mappingU, const T3__& nLambdas, const T4__& mappingL,
                      const T5__& dt, const T6__& params, std::ostream*
                      pstream__) {
  using local_scalar_t__ = stan::return_type_t<T5__, stan::base_type_t<T6__>>;
  int current_statement__ = 0;
  // suppress unused var warning
  (void) current_statement__;
  static constexpr bool propto__ = true;
...
// matrix buildTransitionMatrixDecay(int, matrix, real, real)
template <typename T0__, typename T1__, typename T2__, typename T3__,
          stan::require_all_t<stan::is_integral<T0__>,
                              stan::is_eigen_matrix_dynamic<T1__>,
                              stan::is_vt_not_complex<T1__>,
...
/* array[] real
   buildSizePredictions(int, int, int, array[] vector, array[] vector,
                        array[,] int, int, array[] int, array[,] real)
 */
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__, typename T7__,
          typename T8__,
...
/* array[] real
   buildPropPredictions(int, int, int, array[] vector, array[] vector,
                        array[,] int, int, array[] int, array[,] real)
 */
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__, typename T7__,
...
public:
              ...
              stan::model::assign(propsPred_alpha,
                stan::math::pow(
                  stan::model::rvalue(propsPred_eta, "propsPred_eta",
                    stan::model::index_uni(k), stan::model::index_uni(g)),
                  -(2)), "assigning variable propsPred_alpha",
                stan::model::index_uni(k), stan::model::index_uni(g));
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = nPriorUniform_code1 + nPriorHcauchy_code2 +
      nPriorBeta_code3 + nPriorTrNormal_code4 + nPriorExponential_code5 +
      nPriorGamma_code6;
    const size_t num_transformed = emit_transformed_parameters * (nParams +
      (nComps * (2 * nGroups)) + (nGroups * (n_quantity_records * nComps)) +
      (nGroups * (n_quantity_records * nComps)) + (maxNsizesObs * nGroups) +
      (maxNpropsObs * nGroups) + (maxNsizesObs * nGroups) + (maxNsizesObs *
      nGroups) + (maxNsizesObs * nGroups) + (maxNpropsObs * nGroups) +
      (maxNpropsObs * nGroups) + (maxNpropsObs * nGroups) + (maxNuniqueDts *
      (nComps * nComps)) + (maxNuniqueDts * (nComps * nComps)) + (nComps *
      nComps) + (nComps * nComps) + (nComps * nComps) + (nComps * nComps) +
      (maxNtimeIntervals * nComps) + (maxNtimeIntervals * nComps));
