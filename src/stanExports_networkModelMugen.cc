...
#include "stanExports_networkModelMugen.h"

RCPP_MODULE(stan_fit4networkModelMugen_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_networkModelMugen")
